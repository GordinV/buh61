...
CREATE OR REPLACE FUNCTION sp_pv_inventuuri_aruanne(integer, date, date, character varying, character varying, character varying)
...
begin
	...
	select curPohivara.id, curPohivara.kood, curPohivara.nimetus, curPohivara.konto, curPohivara.grupp, 
		...
		and curPohivara.soetkpv <= tdKpv2
		and (curpohivara.mahakantud is null or empty(curpohivara.mahakantud) or curPohivara.mahakantud > tdKpv2)
...
GRANT EXECUTE ON FUNCTION sp_pv_inventuuri_aruanne(integer, date, date, character varying, character varying, character varying) TO dbkasutaja;
GRANT EXECUTE ON FUNCTION sp_pv_inventuuri_aruanne(integer, date, date, character varying, character varying, character varying) TO dbpeakasutaja;
GRANT EXECUTE ON FUNCTION sp_pv_inventuuri_aruanne(integer, date, date, character varying, character varying, character varying) TO dbvaatleja;


/*
select * from sp_pv_inventuuri_aruanne(3, date(2020,01,01), date(), '%', '%', '%')
