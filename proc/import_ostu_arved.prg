...
* seach for noms
		...
		Insert Into v_arvread (nomid, kogus, hind, Summa, kbmta, km, kbm, nimetus, konto, tp, kood1, kood2, kood5, MUUD, valuuta, kuurs, kbm_maar) ;
			...
			v_xml_arv_detail.nimetus, 'EUR',1, v_xml_arv_detail.kbm_maar)
	Endscan
