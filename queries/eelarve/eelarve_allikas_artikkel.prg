...
WAIT WINDOW 'Päring...korras, andmed laadimine ...' nowait
TEXT to l_string TEXTMERGE noshow
...
SELECT tegev, allikas, artikkel, qryReport.nimetus, ;
	r.nimetus as asutus ,;
	...
	GROUP BY r.nimetus, tegev, allikas, artikkel, qryReport.nimetus ;
