...
* lisame isikud, kellel arvestused puuduvad, aga koormus on
	...
	Scan
		Insert Into tsd_report (isikukood, nimi, v1020, v1040, v1090, v1100) ;
			VALUES (qryKoormusLisa.isikukood,  qryKoormusLisa.isik,'10',IIF(qryKoormusLisa.koormus > 1, 1,qryKoormusLisa.koormus), qryKoormusLisa.min_sots_alus,qryKoormusLisa.arv_min_sots )
	Endscan
