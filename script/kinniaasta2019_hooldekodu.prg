...
*SET STEP ON
gnHandle2009 = SQLConnect('hooldekodu')
gnHandle2008 = SQLConnect('hooldekodu2019')
...
* asutuse nimekirje
lcString = "select id, nimetus from rekv where id =1" 
*!*	and "+;
...
*		select * from qrySaldoKreedit1 into cursor qrySaldoKreedit
	...
	* kustutame vana lausend
	...
	lcString = "delete from journal where rekvid = " + str(qryrekv.id,9)+ " and kpv = date(2019,12,31) "
